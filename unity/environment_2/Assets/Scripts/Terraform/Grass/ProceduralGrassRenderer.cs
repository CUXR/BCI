...
public class ProceduralGrassRenderer : MonoBehaviour {
    ...
    private void SetData() {
        ...
        instantiatedGrassComputeShader.SetInt("_MaxBladeSegments", grassData.maxSegments);
    ...
    public Vector3[] GetGrassVertices() {
        ...
        uint tris = argsData[0] / 3;
        DrawTriangle[] sourceVertices = new DrawTriangle[tris];
        drawBuffer.GetData(sourceVertices, 0, 0, (int)tris);
